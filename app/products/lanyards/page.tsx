...
const lanyardVariants = [
    ...
    },
    {
        id: 'lan-2',
        name: 'Woven Lanyards',
        description: 'Premium quality with intricate designs woven directly into the fabric',
        image: '/images/products/lanyard-1.jpg',
        basePrice: 1.45,
        priceBreaks: [
    ...
    {
        id: 'lan-3',
        name: 'Eco-Friendly Lanyards',
        description: 'Sustainable options made from recycled materials - perfect for environmentally conscious brands',
        image: '/images/products/lanyard-1.jpg',
        basePrice: 1.25,
        priceBreaks: [
...
const accessories = [
    ...
    },
    {
        ...
        price: 0.15,
        image: '/images/products/accessory-1.jpg',
        description: 'Safety breakaway connectors for secure use'
    },
    {
        id: 'acc-4',
        ...
        price: 0.20,
        image: '/images/products/accessory-1.jpg',
        description: 'Various attachment options: swivel hooks, split rings, clips'
    }
];

export default function LanyardsPage() {
    const [selectedVariant, setSelectedVariant] = useState(lanyardVariants[0]);
    const [quantity, setQuantity] = useState(100);
    const [selectedWidth, setSelectedWidth] = useState('5/8"');
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="bg-gray-50 border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>/</span>
                        <span className="text-gray-900 font-medium">Lanyards</span>
                    </div>
                </div>
            </div>
            ...
            <main className="flex-grow">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-xl text-blue-100 mb-6">
                                    Premium quality lanyards for events, schools, businesses, and organizations
                                </p>
                                <ul className="space-y-3 text-blue-50">
                                    ...
                                    <li className="flex items-center gap-3">
                                        ...
                                        <span>Multiple material and width options</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <svg className="w-6 h-6 text-ln-yellow" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <section className="py-16 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <p className="text-center text-gray-600 mb-12">
                            Select the perfect lanyard material for your needs
                        </p>

                        <div className="grid md:grid-cols-3 gap-8">
                            {lanyardVariants.map((variant) => (
                                <div
                                    key={variant.id}
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button
                                        onClick={() => setSelectedWidth('5/8"')}
                                        className={`py-3 px-4 rounded-lg font-semibold transition-all ${selectedWidth === '5/8"'
                                            ? 'bg-ln-blue text-white shadow-md'
                                            : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                            }`}
                                    >
                                    ...
                                    <button
                                        onClick={() => setSelectedWidth('3/4"')}
                                        className={`py-3 px-4 rounded-lg font-semibold transition-all ${selectedWidth === '3/4"'
                                            ? 'bg-ln-blue text-white shadow-md'
                                            : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                            }`}
                                    >
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-2">
                                    {['Safety Breakaway', 'Badge Holder', 'Badge Reel', 'Custom Attachment'].map((option) => (
                            ...
                            {[
                                {
                                    icon: '🎨',
                                    title: 'Custom Design',
                                    description: 'Full color printing with your logo and branding'
                                },
                                {
                                    icon: '💪',
                                ...
                                },
                                {
                                    ...
                                    description: '7-10 business days standard turnaround'
                                },
                                {
                                    icon: '💎',
                                    title: 'Premium Quality',
                                    description: 'Professional finish for any occasion'
                                }
                            ].map((feature, idx) => (
                ...
                <section className="py-16 bg-white">
                    <div className="max-w-7xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">
                            Complete Your Lanyard System
                        </h2>
                        <p className="text-center text-gray-600 mb-12">
                            Add these accessories to make your lanyards even more functional
                        </p>
                ...
                <section className="py-16 bg-gradient-to-r from-ln-blue to-blue-700 text-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        ...
                        <p className="text-xl text-blue-100 mb-8">
                            Get a free quote or speak with our lanyard specialists
                        </p>
