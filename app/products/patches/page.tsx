...
const patchVariants = [
    {
        ...
        description: 'Classic embroidered patches with premium thread - perfect for uniforms, jackets, and bags',
        image: '/images/products/patch-1.jpg',
        basePrice: 1.89,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 1.89 },
            { minQuantity: 500, unitPrice: 1.69 },
            { minQuantity: 1000, unitPrice: 1.49 },
            { minQuantity: 5000, unitPrice: 1.29 },
        ],
        features: [
            'Up to 75% embroidery coverage',
            'Multiple backing options',
            'Custom shapes and sizes',
            'Premium rayon thread',
            'Merrowed or heat-cut borders',
            'Iron-on or sew-on available'
        ]
    },
    {
        id: 'p-2',
        name: 'PVC Patches',
        description: 'Durable rubber patches - waterproof and perfect for outdoor gear and tactical applications',
        image: '/images/products/patch-1.jpg',
        basePrice: 2.25,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 2.25 },
            { minQuantity: 500, unitPrice: 2.05 },
            { minQuantity: 1000, unitPrice: 1.85 },
            { minQuantity: 5000, unitPrice: 1.65 },
        ],
        features: [
            '3D molded design',
            ...
            'Perfect for tactical gear'
        ]
    },
    {
        id: 'p-3',
        name: 'Woven Patches',
        description: 'High-detail woven patches - ideal for intricate designs and fine text',
        image: '/images/products/patch-1.jpg',
        basePrice: 1.65,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 1.65 },
            { minQuantity: 500, unitPrice: 1.45 },
            { minQuantity: 1000, unitPrice: 1.25 },
            { minQuantity: 5000, unitPrice: 1.05 },
        ],
        features: [
...
export default function PatchesPage() {
    const [selectedVariant, setSelectedVariant] = useState(patchVariants[0]);
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="bg-gray-50 border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>/</span>
                        <span className="text-gray-900 font-medium">Patches</span>
                    </div>
                </div>
            </div>
            ...
            <main className="flex-grow">
                <section className="bg-gradient-to-br from-ln-blue to-blue-700 text-white py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">Custom Patches</h1>
                                <p className="text-xl text-blue-100 mb-6">
                                    High-quality custom patches for uniforms, apparel, bags, and promotional items
                                </p>
                                <ul className="space-y-3 text-blue-50">
                                    <li className="flex items-center gap-3">
                                        ...
                                        <span>Multiple patch types available</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <svg className="w-6 h-6 text-ln-yellow" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                    ...
                                    <li className="flex items-center gap-3">
                                        ...
                                        <span>Fast turnaround - 10-12 business days</span>
                                    </li>
                                </ul>
                            </div>
                            <div className="relative h-80 md:h-96 rounded-lg overflow-hidden shadow-2xl">
                                <Image src="/images/products/patch-1.jpg" alt="Custom Patches" fill className="object-cover" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">Choose Your Patch Type</h2>
                        <p className="text-center text-gray-600 mb-12">Select the perfect patch style for your needs</p>

                        <div className="grid md:grid-cols-3 gap-8">
                            {patchVariants.map((variant) => (
                                <div
                                    key={variant.id}
                ...
                <section className="py-16 bg-gradient-to-r from-ln-blue to-blue-700 text-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        <h2 className="text-4xl font-bold mb-4">Ready to Order Your Custom Patches?</h2>
                        <p className="text-xl text-blue-100 mb-8">Get a free quote or speak with our patch specialists</p>
