...
const wristbandVariants = [
    {
        id: 'wb-1',
        name: 'Silicone Wristbands',
        description: 'Classic debossed or embossed silicone bands - perfect for events, fundraisers, and awareness campaigns',
        image: '/images/products/wristband-1.jpg',
        basePrice: 0.35,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 0.35 },
            { minQuantity: 500, unitPrice: 0.29 },
            { minQuantity: 1000, unitPrice: 0.25 },
            { minQuantity: 5000, unitPrice: 0.20 },
        ],
        features: [
    ...
    },
    {
        ...
        description: 'Economical paper-like wristbands ideal for events, festivals, and admission control',
        image: '/images/products/wristband-1.jpg',
        basePrice: 0.15,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 0.15 },
            { minQuantity: 500, unitPrice: 0.12 },
            { minQuantity: 1000, unitPrice: 0.10 },
            { minQuantity: 5000, unitPrice: 0.08 },
        ],
        features: [
            'Water-resistant Tyvek material',
            'Tamper-proof adhesive closure',
    ...
    },
    {
        ...
        description: 'Durable plastic wristbands for multi-day events and extended wear',
        image: '/images/products/wristband-1.jpg',
        basePrice: 0.25,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 0.25 },
            { minQuantity: 500, unitPrice: 0.22 },
            { minQuantity: 1000, unitPrice: 0.19 },
            { minQuantity: 5000, unitPrice: 0.16 },
        ],
        features: [
            ...
            'Full color printing',
            'Stretch-resistant',
            'Great for water parks and resorts'
        ]
    }
];
...
const accessories = [
    {
        ...
        description: 'Professional display boxes for retail or giveaways'
    },
    {
        id: 'acc-2',
        name: 'Packaging Bags',
        price: 0.15,
        image: '/images/products/accessory-1.jpg',
        description: 'Individual poly bags for clean presentation'
    },
    {
        id: 'acc-3',
        name: 'Custom Cards',
        price: 0.25,
        image: '/images/products/accessory-1.jpg',
        description: 'Branded cards to attach your wristbands'
    },
    {
        id: 'acc-4',
        ...
        price: 12.99,
        image: '/images/products/accessory-1.jpg',
        description: 'Storage containers for large quantities'
    }
];

export default function WristbandsPage() {
    const [selectedVariant, setSelectedVariant] = useState(wristbandVariants[0]);
    const [quantity, setQuantity] = useState(100);
    const [selectedSize, setSelectedSize] = useState('adult');
            ...
            <div className="bg-gray-50 border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>/</span>
                        <span className="text-gray-900 font-medium">Wristbands</span>
                    </div>
                </div>
            </div>
            ...
            <main className="flex-grow">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-xl text-blue-100 mb-6">
                                    High-quality wristbands for events, fundraisers, awareness campaigns, and more
                                </p>
                                <ul className="space-y-3 text-blue-50">
                                    ...
                                    <li className="flex items-center gap-3">
                                        ...
                                        <span>Custom colors, text, and logos</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <svg className="w-6 h-6 text-ln-yellow" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                            ...
                            <div className="relative h-80 md:h-96 rounded-lg overflow-hidden shadow-2xl">
                                <Image
                                    src="/images/products/wristband-1.jpg"
                ...
                <section className="py-16 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">
                            Choose Your Wristband Type
                        </h2>
                        <p className="text-center text-gray-600 mb-12">
                            Select the perfect wristband material for your event or campaign
                        </p>

                        <div className="grid md:grid-cols-3 gap-8">
                            {wristbandVariants.map((variant) => (
                                <div
                                    key={variant.id}
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg">
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={`py-3 px-4 rounded-lg font-semibold transition-all ${selectedSize === 'adult'
                                                ? 'bg-ln-blue text-white shadow-md'
                                                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                                }`}
                                        >
                                        ...
                                        <button
                                            onClick={() => setSelectedSize('youth')}
                                            className={`py-3 px-4 rounded-lg font-semibold transition-all ${selectedSize === 'youth'
                                                ? 'bg-ln-blue text-white shadow-md'
                                                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                                }`}
                                        >
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-2">
                                    {['Individual Packaging', 'Custom Colors', 'Rush Production', 'Design Service'].map((option) => (
                            ...
                            {[
                                {
                                    icon: '🎨',
                                    title: 'Custom Design',
                                    description: 'Personalize with your message, logo, and colors'
                                },
                                {
                                    icon: '💪',
                                    title: 'Durable Quality',
                                    description: 'Made from premium materials that last'
                                },
                                {
                                    icon: '⚡',
                                    title: 'Fast Delivery',
                                    description: '5-7 business days standard turnaround'
                                },
                                {
                                    icon: '💰',
                                    title: 'Best Prices',
                ...
                <section className="py-16 bg-white">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <p className="text-center text-gray-600 mb-12">
                            Professional packaging solutions for your wristbands
                        </p>
                ...
                <section className="py-16 bg-gradient-to-r from-ln-blue to-blue-700 text-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        ...
                        <p className="text-xl text-blue-100 mb-8">
                            Get a free quote or speak with our wristband specialists
                        </p>
