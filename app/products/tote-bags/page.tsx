...
const toteBagVariants = [
    {
        ...
        description: 'Classic canvas totes - eco-friendly, durable, and perfect for everyday use',
        image: '/images/products/tote-1.jpg',
        basePrice: 2.45,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 2.45 },
            { minQuantity: 500, unitPrice: 2.25 },
            { minQuantity: 1000, unitPrice: 2.05 },
            { minQuantity: 5000, unitPrice: 1.85 },
        ],
        features: [
    ...
    {
        id: 'tb-2',
        name: 'Non-Woven Tote Bags',
        description: 'Economical and lightweight - great for events, trade shows, and giveaways',
        image: '/images/products/tote-1.jpg',
        basePrice: 1.25,
        priceBreaks: [
    ...
    {
        id: 'tb-3',
        name: 'Premium Tote Bags',
        description: 'High-end totes with premium features - perfect for corporate gifts and retail',
        image: '/images/products/tote-1.jpg',
        basePrice: 4.95,
        priceBreaks: [
            { minQuantity: 100, unitPrice: 4.95 },
            { minQuantity: 500, unitPrice: 4.75 },
            { minQuantity: 1000, unitPrice: 4.55 },
            { minQuantity: 5000, unitPrice: 4.35 },
        ],
        features: [
            'Premium heavyweight canvas',
...
export default function ToteBagsPage() {
    const [selectedVariant, setSelectedVariant] = useState(toteBagVariants[0]);
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="bg-gray-50 border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>/</span>
                        <span className="text-gray-900 font-medium">Tote Bags</span>
                    </div>
                </div>
            </div>
            ...
            <main className="flex-grow">
                <section className="bg-gradient-to-br from-ln-blue to-blue-700 text-white py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">Custom Tote Bags</h1>
                                <p className="text-xl text-blue-100 mb-6">
                                    Eco-friendly custom tote bags for retail, events, and promotional campaigns
                                </p>
                                <ul className="space-y-3 text-blue-50">
                                    <li className="flex items-center gap-3">
                                        ...
                                        <span>Eco-friendly material options</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <svg className="w-6 h-6 text-ln-yellow" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                            ...
                            <div className="relative h-80 md:h-96 rounded-lg overflow-hidden shadow-2xl">
                                <Image src="/images/products/tote-1.jpg" alt="Custom Tote Bags" fill className="object-cover" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">Choose Your Tote Bag Type</h2>
                        <p className="text-center text-gray-600 mb-12">Select the perfect tote bag for your needs</p>

                        <div className="grid md:grid-cols-3 gap-8">
                            {toteBagVariants.map((variant) => (
                                <div
                                    key={variant.id}
                ...
                <section className="py-16 bg-gradient-to-r from-ln-blue to-blue-700 text-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        <h2 className="text-4xl font-bold mb-4">Ready to Order Your Custom Tote Bags?</h2>
